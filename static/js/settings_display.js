...
import render_dialog_default_language from "../templates/dialog_default_language.hbs";
...
export function set_up(settings_panel) {
    ...
    function setup_default_language_modal_handler() {
    ...
    container.find(".setting_default_language").on("click", (e) => {
        ...
        const html_body = render_dialog_default_language({
            language_list: get_language_list_columns(page_params.default_language),
        });
        ...
        dialog_widget.launch({
            ...
            post_render: setup_default_language_modal_handler,
            on_click: () => {},
        });
    });
