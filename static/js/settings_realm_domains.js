...
export function maybe_populate_realm_domains_table(realm_domains) {
    // Populate only if the modal is present.
...
export function show_realm_domains_modal() {
    ...
    dialog_widget.launch({
        ...
        post_render: () => {
            ...
            maybe_populate_realm_domains_table(page_params.realm_domains);
        },
    });
}
