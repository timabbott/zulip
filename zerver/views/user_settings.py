...
def json_change_notify_settings(
        ...
        wildcard_mention_desktop_notifications: Optional[bool]=REQ(validator=check_bool, default=None),
        wildcard_mention_email_notifications: Optional[bool]=REQ(validator=check_bool, default=None),
        wildcard_mention_push_notifications: Optional[bool]=REQ(validator=check_bool, default=None),
        wildcard_mention_audible_notifications: Optional[bool]=REQ(validator=check_bool, default=None),
