...
def fetch_initial_state_data(
    ...
    *,
    ...
    if want("realm"):
        ...
        state["realm_push_notifications_enabled"] = realm.push_notifications_enabled
        state[
            "realm_push_notifications_enabled_end_date"
        ] = realm.push_notifications_enabled_end_date
