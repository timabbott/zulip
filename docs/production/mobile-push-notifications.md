...
job. If you'd like to access plan management after enabling
`SUBMIT_USAGE_STATISTICS=True` on a Zulip server that hasn't been
upgraded to 8.0 yet, you can run the analytics job manually via:
