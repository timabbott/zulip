...
DEFAULT_SETTINGS.update({
    ...
    'ROOT_SUBDOMAIN_ALIASES': ["auth", "www"],
...
if SOCIAL_AUTH_SUBDOMAIN:
    SOCIAL_AUTH_DOMAIN_URI = EXTERNAL_URI_SCHEME + SOCIAL_AUTH_SUBDOMAIN + "." + EXTERNAL_HOST
else:
    SOCIAL_AUTH_DOMAIN_URI = ROOT_DOMAIN_URI
